...
.. image:: img/colorful_square1.png
...
This project has a lot in common with  `Clickable Dot <clickable_dot.html>`_ , except that it refines the conditions for determining mouse click event.

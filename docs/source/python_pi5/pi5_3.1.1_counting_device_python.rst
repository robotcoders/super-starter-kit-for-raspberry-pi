...
We will create a number-displaying counter system, comprising a PIR 
(Passive Infrared) sensor and a 4-digit seven-segment display. When 
the PIR sensor detects someone passing by, the number displayed on the 
4-digit seven-segment display will increment by 1. This counter can be 
used to count the number of people walking through a passageway
...
.. image:: ../python_pi5/img/list/4.1.7_counting_device_list_1.png
    :align: center

.. image:: ../python_pi5/img/list/4.1.7_counting_device_list_2.png
    :align: center
...
.. image:: ../python_pi5/img/schematic/4.1.7_counting_device_schematic.png
   :align: center
...
.. image:: ../python_pi5/img/connect/3.1.1.png

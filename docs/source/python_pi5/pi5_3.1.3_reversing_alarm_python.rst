...
In this project, we will utilize an LCD display, a buzzer, 
and ultrasonic sensors to create a reverse assist system. 
We can integrate it into a remote-controlled vehicle to 
simulate the actual process of reversing a car into a garage.
...
.. image:: ../python_pi5/img/list/4.1.9_reversing_alarm_list.png
    :width: 800
    :align: center
...
.. image:: ../python_pi5/img/schematic/4.1.9_reversing_alarm_schematic.png
   :align: center
...
.. image:: ../python_pi5/img/connect/3.1.3.png
    :align: center
